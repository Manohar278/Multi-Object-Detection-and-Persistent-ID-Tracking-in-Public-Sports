...
if st.button("🚀 Start Tracking"):
    ...
    os.system(f"ffmpeg -y -i {out_path} -vcodec libx264 -crf 23 -preset fast {h264_path}")

    final_path = h264_path if os.path.exists(h264_path) and os.path.getsize(h264_path) > 0 else out_path

    st.success("✅ Tracking complete! Playing output video below 👇")
